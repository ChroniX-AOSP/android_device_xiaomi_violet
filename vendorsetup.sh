#Device Tree
git clone https://github.com/xiaomi-sm6150/android_device_xiaomi_sm6150-common.git device/xiaomi/sm6150-common
#Vendor Tree
git clone https://github.com/xiaomi-sm6150/proprietary_vendor_xiaomi_violet.git vendor/xiaomi/violet
